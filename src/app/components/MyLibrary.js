...
export default function MyLibrary() {
    ...
    const fetchData = async () => {
      try {
        ...
        const currentlyReadingResponse = await fetch(
          "http://http://api.aamirah.netbuildertraining.com/currently-reading"
        );
        ...
        const wantToReadResponse = await fetch(
          "http://http://api.aamirah.netbuildertraining.com/want-to-read"
        );
  ...
  const deleteBook = async (id, collection) => {
    try {
      await fetch(`http://http://api.aamirah.netbuildertraining.com/${collection}/${id}`, {
        method: "DELETE",
      });
      if (collection === "books") {
  ...
  const moveToRead = async (id) => {
    ...
    try {
      const response = await fetch(
        `http://http://api.aamirah.netbuildertraining.com/currently-reading/${id}/move-to-read`,
        {
          method: "PUT",
          headers: {
  ...
  const addBook = async (formData) => {
    ...
    try {
      const response = await fetch(`http://http://api.aamirah.netbuildertraining.com/${collection}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
